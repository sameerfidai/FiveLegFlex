...
const API_URL = "https://fivelegflex-backend.fly.dev/api/best-props-laliga";
const LOCAL_URL = "http://0.0.0.0:8080/api/best-props-laliga";
...
export default LaLigaPropsPage;
