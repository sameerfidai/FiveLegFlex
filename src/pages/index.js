...
export default function Home({ bettingProps }) {
  return (
    <div className="p-8 bg-black1 text-white">
      {bettingProps.length > 0 ? (
        <div className="p-8 bg-black2 text-white">
          <div className="flex justify-center">
            <h1 className="text-4xl font-bold text-gold">FiveLegFlex</h1>
          </div>
        ...
        <div className="text-center">
          <h2 className="text-l font-semibold">No NBA props live at this time</h2>
        </div>
      )}
    </div>
  );
