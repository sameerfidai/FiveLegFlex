        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {bettingProps.data.map((prop, index) => (
              <div key={index} className="bg-black2 shadow-xl rounded-xl p-5 flex flex-col justify-between h-full hover:bg-fullblack hover:scale-105 hover:shadow-2xl transition-transform duration-300 ease-in-out">
